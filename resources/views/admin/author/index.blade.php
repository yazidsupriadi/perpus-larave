                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Author Dashboard</h2>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" action="{{url('admin/author/search')}}" method="get">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    {{csrf_field()}}
                                                    {{method_field('DELETE')}}        
                                                    <a href="{{url('admin/author/'.$author->id.'/edit')}}" class="btn btn-success btn-sm"  ">edit</a>
