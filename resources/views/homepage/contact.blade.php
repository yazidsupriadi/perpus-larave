                    ...
                    <form action="{{url('contact')}}" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="phone" placeholder="Masukan judul nomor telpon"  >
                      </div>
                                            <div class="form-group">
                        <label for="name">Comment</label>
                        <textarea name="comment" class="form-control" placeholder="masukan comment anda"></textarea>
                      </div>
